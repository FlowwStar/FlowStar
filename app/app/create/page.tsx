        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {recipientAccountInfo && !recipientAccountInfo.exists && (
                <div className="flex items-start gap-2 rounded-lg border border-amber-500/40 bg-amber-500/10 p-3 text-sm text-amber-600 dark:text-amber-400">
                  ...
                  <div className="flex-1">
                    <p className="font-medium">This address has no transaction history.</p>
                    <p className="text-xs mt-1">Tokens sent to this address may be unrecoverable if it's not funded.</p>
                    <Button
                      type="button"
                      size="sm"
                      variant="outline"
          ...
          <div className="rounded-2xl border border-border bg-card p-5 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={selectedTimezone} onValueChange={(v) => { if (v) setSelectedTimezone(v) }}>
